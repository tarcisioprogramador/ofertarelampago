...
export default async function HomePage() {
  ...
  const homeFaqs = [
    ...
    { question: "Como funcionam os links de ofertas?", answer: "Quando você compra pelo nosso link, podemos receber uma comissão da loja — sem nenhum custo extra para você. Isso mantém o site gratuito e não influencia nossas recomendações." },
